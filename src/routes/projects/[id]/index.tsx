    ...
    <>
      <div class="mt-64 flex w-screen flex-col justify-center gap-64 sm:gap-32 md:mt-0 md:gap-64 lg:gap-96 xl:w-1280 ">
        ...
        <section class="container flex min-w-full items-center ">
          <div class="flex w-1280 flex-col items-center gap-32 md:rounded-4xl bg-bgColor py-64 md:gap-64 lg:gap-96 xl:gap-128">

            <div class="min-h-80 flex max-w-996 flex-col items-center justify-around gap-32 rounded-4xl bg-white px-32 py-32 w-60% md:w-90% md:flex-row">
              <div class="flex flex-col items-center gap-4 md:gap-8">
                <h6 class="text-19 font-medium">Industry</h6>
                <span class="text-16">{projectData?.industry ? projectData.industry : "N/A"}</span>
              </div>

              <div class="flex flex-col items-center gap-4 md:gap-8">
                <h6 class="text-19 font-medium">Location</h6>
                <span class="text-16">{projectData.location ? projectData.location : "N/A"}</span>
              </div>
              ...
              <div class="flex flex-col items-center gap-4 md:gap-8">
                ...
                {projectData?.projectUrl ? (
                  ...
                  <a href={projectData?.projectUrl ? projectData.projectUrl : ""} target="_blank">
                    click me
                  </a>
