...
export default component$(() => {
  return (
    <section class="flex flex-col items-center">
      <div class="mx-32 my-64 flex flex-col items-center gap-24 rounded-4xl bg-bgColor py-24 sm:px-64 lg:flex-row-reverse lg:py-64 xl:max-h-420 xl:px-112 xl:py-93">
